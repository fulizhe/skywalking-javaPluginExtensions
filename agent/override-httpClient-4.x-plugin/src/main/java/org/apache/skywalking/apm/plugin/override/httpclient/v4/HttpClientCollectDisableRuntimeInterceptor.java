...
public class HttpClientCollectDisableRuntimeInterceptor implements StaticMethodsAroundInterceptor {
    private static final ILog LOGGER = LogManager.getLogger(HttpClientCollectDisableRuntimeInterceptor.class);
    ...
    public void beforeMethod(final Class clazz,
        ...
        LOGGER.info("### Disable runtime override httpclient parameter collection, params={}, status={}",
