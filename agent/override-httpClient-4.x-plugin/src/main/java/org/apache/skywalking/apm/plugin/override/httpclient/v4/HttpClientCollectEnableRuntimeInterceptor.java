...
public class HttpClientCollectEnableRuntimeInterceptor implements StaticMethodsAroundInterceptor {
    private static final ILog LOGGER = LogManager.getLogger(HttpClientCollectEnableRuntimeInterceptor.class);
