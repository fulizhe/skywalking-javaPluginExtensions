 ...
 * 启用agent向server端发送数据
 */
public class LogfileReporterDisableRuntimeInterceptor implements StaticMethodsAroundInterceptor {
	private static final ILog LOGGER = LogManager.getLogger(LogfileReporterDisableRuntimeInterceptor.class);
	...
	public void beforeMethod(Class clazz, Method method, Object[] allArguments, Class<?>[] parameterTypes,
		...
		LOGGER.info("============================================================");
		LOGGER.info("### disable for agent-enable status of [ {} ] by [ {} ]", Config.Agent.SERVICE_NAME, methodParams);
		LOGGER.info("============================================================");
		...
		invokeMethod(traceSegmentServiceClient, "toggleEnable", false);
	}
