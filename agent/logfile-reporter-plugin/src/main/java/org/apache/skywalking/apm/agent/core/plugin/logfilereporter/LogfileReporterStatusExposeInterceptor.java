...
public class LogfileReporterStatusExposeInterceptor implements StaticMethodsAroundInterceptor {
	...
	public void beforeMethod(Class clazz, Method method, Object[] allArguments, Class<?>[] parameterTypes,
		...
		// 与 data/jvm 相同：经 BootService 实例反射，避免 PluginClassLoader 读到另一份 TraceAlertMetrics/Config
		final Object traceAlertMetrics = ReflectUtil.invoke(client, "getTraceAlertMetrics");
		if (traceAlertMetrics == null) {
			LOGGER.warn("### [TraceAlert] getTraceAlertMetrics returned null from TraceSegmentServiceClient.");
		}
		resultMap.put("traceAlert", traceAlertMetrics);
